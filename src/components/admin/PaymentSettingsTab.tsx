    ...
    <Card className="border-0 shadow-none md:border md:shadow-sm">
      ...
      <CardContent className="px-4 md:px-6">
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 md:space-y-6">
          ...
          <div className="space-y-2">
            <Label htmlFor="decimal_places" className="text-sm md:text-base">
              Número de decimales
            </Label>
            <Input
              id="decimal_places"
          ...
          <div className="space-y-2">
            <Label htmlFor="decimal_separator" className="text-sm md:text-base">
              Separador decimal
            </Label>
            <Input
          ...
          <div className="space-y-2">
            <Label htmlFor="thousands_separator" className="text-sm md:text-base">
              Separador de miles
            </Label>
            <Input
          ...
          <div className="space-y-2">
            <Label htmlFor="accept_cash" className="text-sm md:text-base">
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs md:text-sm text-muted-foreground">
              Si está activado, el cliente deberá subir obligatoriamente un comprobante de pago al hacer el pedido. Si
              está desactivado, el campo de comprobante estará oculto.
            </p>
          </div>
